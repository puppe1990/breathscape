        ...
        <div className="text-center space-y-6 sm:space-y-8 mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-3 mb-4 sm:mb-6">
            ...
            <span className="text-sm sm:text-base font-medium text-blue-600 dark:text-blue-400 bg-blue-100 dark:bg-blue-900/30 px-4 py-2 rounded-full">
              {t.footer?.mindfulBreathing || "Mindful Breathing"}
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12">
            <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-slate-100">{t.footer?.relaxation || "Relaxation"}</h3>
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">{t.footer?.relaxationDescription || "Reduce stress and anxiety"}</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-slate-100">{t.footer?.focus || "Focus"}</h3>
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">{t.footer?.focusDescription || "Improve concentration"}</p>
            </div>
            <div className="flex flex-col items-center text-center space-y-3 sm:space-y-4 sm:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-slate-100">{t.footer?.wellness || "Wellness"}</h3>
              <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400">{t.footer?.wellnessDescription || "Enhance overall health"}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-slate-200/50 dark:border-slate-700/50 py-4 sm:py-6">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-slate-500 dark:text-slate-500 flex items-center justify-center gap-2">
            {t.footer?.madeWith || "Made with"} <Heart className="w-4 h-4 text-rose-500" /> {t.footer?.forMindfulBreathing || "for mindful breathing"}
          </p>
        </div>
      </div>
    </footer>
