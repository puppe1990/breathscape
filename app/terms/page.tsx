      ...
      <section className="container max-w-3xl py-12 md:py-16">
        <div className="space-y-4 text-center">
          ...
          <p className="text-muted-foreground">
            Please read these terms carefully before using Breathscape.
          </p>
        </div>
        ...
        <div className="mt-10 space-y-6">
          <section className="surface-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              By accessing or using Breathscape, you agree to be bound by these Terms of Use. If you
          ...
          <section className="surface-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Breathscape is provided for personal, non-commercial use. Do not misuse the app,
              interfere with its operation, or attempt to access it using methods other than the
              interface provided.
            </p>
          </section>
          ...
          <section className="surface-card p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Breathscape offers breathing exercises for relaxation and mindfulness. It is not a
              medical device and does not provide medical advice. Consult a qualified professional
              for health concerns.
            </p>
          </section>
